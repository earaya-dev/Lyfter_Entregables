        ...
        if user_input == "1":           
            ...
            try:
                ...
                for student_count in range(number_of_students):
                    main_student_collection.append(create_student())
            except ValueError:
            ...
            current_action = 5
            export_data_to_csv_file(CSV_PATH, main_student_collection)

            print("\n Student data has been exported to 'student_information_list.csv'successfully.")
        elif user_input == "6":
            current_action = 6
            main_student_collection = import_data_from_exported_file(CSV_PATH)
        elif user_input == "7":
            print(f'Goodbye!')
            break
        else:
